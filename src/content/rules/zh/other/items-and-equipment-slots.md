...
武器伤害上限：  
所有非天生武器都具有伤害上限，一把武器的伤害上限为该武器原本的武器伤害\*2，这意味着你通过招式、能力或特性至多可以将一把武器的武器伤害再提升一倍。如果该武器具有【神兵】特性，则武器伤害的上限改为该武器原本的武器伤害\*3。  
若没有特殊说明，通过附魔或改造提升的武器伤害，计入武器原本的武器伤害中。
...
盔甲防御、盾牌防御或者天生防御若其正在生效，则穿戴者在针对范围伤害的攻击检定时，若没有特殊说明则依然生效。则意味着该范围伤害若可以以反射检定豁免伤害，则穿戴者在反射检定上获得等额的器械加值。

若该范围伤害具备破甲，则该破甲可以如常生效，这表现为降低目标因盔甲防御、盾牌防御以及天生防御为反射豁免带来的器械加值。
...
复制、投影等类似能力，复制、投影出来的物品无法使用有次数限制的能力。

武器基本属性中的破甲与破魔属性全部为“获得”。
...
| 7 | 钢、铁 |
| 13 | 精金 |
| +1 | 物品的每个附魔等级，或物品的每层加固（如复合装甲） |

若一个物品未说明其结构值和硬度（而你又想破坏它的话），物品的结构值一般等于其**体积****+****硬度**。若一件物品被认定为结构精巧而脆弱（例如科技造物），则其结构值会减少1~5点，由ST判定。此外，物品的价格每包含一个D支线都会提供给物品5点生命值和2点硬度，如C级物品则多15点生命值和6点硬度。

需要注意的是，物品的硬度不会影响角色的防御。

如角色穿戴一个盔甲，盔甲本身的硬度不会帮助角色在防御上获得任何优势。盔甲的硬度只在其他角色击破盔甲的时候才有用。

同样，载具也是如此。但是对于全封闭的载具，目标若没有特殊能力是无法攻击驾驶员的。
...
3.   神兵可以击破“/神兵”“/魔法”或者除“/精金”与“/银”以外的任何特定材质的伤害减免。
...
有的概念武装平时不生效，可以根据该概念武装的说明将其起效，但是若该对应的装备位已有物品，则无法起效。若没有特殊说明，则解除概念武装效果是一个自由动作。

有的概念武装自获得时开启，则一直生效。

同一时间你只能装备一个概念武装，这意味着你可以携带多个概念武装，但是除了一个其余皆不生效。
...
部分资源具有可购买的专属物品，开启这些专属物品购买权如同开启技能树一样被视为一个前提，只有开启了专属物品兑换的角色才可以购买和使用对应的专属物品。如无特殊说明，专属物品无法被其他人使用以及发动任何特性。
...
| 力量值 | 轻度负荷 | 中度负荷 | 重度负荷 |
| --- | --- | --- | --- |
| 1 | 13 公斤以下 | 14-26 公斤 | 27-40 公斤 |
| 2 | 16 公斤以下 | 17-33 公斤 | 34-50 公斤 |
| 3 | 21 公斤以下 | 22-43 公斤 | 44-65 公斤 |
| 4 | 29 公斤以下 | 30-58 公斤 | 59-88 公斤 |
| 5 | 37 公斤以下 | 38-76 公斤 | 77-115 公斤 |
| 6 | 50 公斤以下 | 50-100 公斤 | 101-150 公斤 |
| 7 | 66 公斤以下 | 67-133 公斤 | 134-200 公斤 |
| 8 | 86 公斤以下 | 87-173 公斤 | 174-260 公斤 |
| 9 | 126 公斤以下 | 127-233 公斤 | 234-350 公斤 |
| 10 | 153 公斤以下 | 154-306 公斤 | 307-460 公斤 |
